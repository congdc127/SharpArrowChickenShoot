...
public class ParticleControl : MonoBehaviour {
    ...
    public static OnCoinAdded onCoinAdded;

    public delegate void OnControlledParticlesEnded();
    public static OnControlledParticlesEnded onControlledParticlesEnded;
    ...
    public static void PlayCoinParticles(Vector2 screenPos, RectTransform targetUI, int particleCount)
    {
        if (instance == null) return;

        instance.PlayControlledParticles(screenPos, targetUI, particleCount);
    }
